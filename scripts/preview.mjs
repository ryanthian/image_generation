...
createServer(async (incoming, outgoing) => {
  ...
  if (incoming.method === "GET" && url.pathname === "/api/recipes") {
    ...
    outgoing.end(JSON.stringify({ ok: true, source: "snapshot", writable: false, sheetName: "Local verification snapshot", sheets: [{ name: "Local verification snapshot", label: "Local verification snapshot" }], ...recipes }));
    return;
  }
